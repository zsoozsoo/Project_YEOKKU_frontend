<template>
  <div>
    ...
    <label for="exampleSelect1" class="form-label mt-4"
      >선택하신 지역의 음악 순위 TOP100을 만나보세요</label
    >
        ...
        <table class="table table-hover" style="user-select: auto">
          <thead style="user-select: auto">
            <tr style="user-select: auto">
              ...
              <th scope="col" style="user-select: auto">가수</th>
          ...
          <tbody style="user-select: auto">
            <tr
              ...
              :key="music.songTitle"
              v-on:click="musicDetail(music.chartRank)"
            >
              ...
              <td style="user-select: auto">{{ music.singer }}</td>
              <td style="user-select: auto">{{ music.chartRank }}</td>
...
export default {
  ...
  computed: {},
  methods: {
    ...mapActions("musicStore", ["SET_MUSIC_ID"]),
    ...
    selectCountry(event) {
      ...
      console.log("pointinfo/music/" + country);
      http
        .get("pointinfo/music/" + country)
        .then(({ data }) => {
          this.musicList = data;
    ...
    musicDetail: function (mid) {
      // console.log(mid);
      this.SET_MUSIC_ID(mid);
      this.$router.push("/music/musicdetail");
    },
  },
};
</script>
